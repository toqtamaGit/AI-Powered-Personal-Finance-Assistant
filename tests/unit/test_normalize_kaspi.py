"""
Unit tests for Kaspi normalizer — parse_details (pure function, no I/O).

Run:  python -m pytest tests/unit/test_normalize_kaspi.py -v
"""
import pytest

from parsers.normalize_kaspi import parse_details
